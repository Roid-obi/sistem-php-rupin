...
<html>
<head>
    <title>Detail Booking - RuPin</title>
    <style>
...
<body>
    <div class="navigation">
        ...
        <a href="index.php?action=lihatDetailBooking&id=1">Lihat Booking (Simulasi ID 1)</a>
    </div>

    <div class="detail-container">
        <h1>Detail Booking #<?php echo $booking->bookingId; ?></h1>
        <p><strong>Item:</strong> <?php echo $item['nama']; ?></p>
        <p><strong>Status:</strong> <?php echo $booking->status; ?></p>
        <p><strong>Denda:</strong> Rp <?php echo number_format($booking->denda, 0, ',', '.'); ?></p>
        <a href="index.php?action=lihatStatusBooking&id=<?php echo $booking->bookingId; ?>" class="button">Lihat Status Terbaru</a>
        <a href="index.php?action=batalkanPesanan&id=<?php echo $booking->bookingId; ?>" class="button">Batalkan Pesanan</a>
